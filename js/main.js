...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "Below is a list of commands you can use. You can use the TAB key for auto-completion.",
        ls_help: "It is used to list the files in the current directory.",
        cat_help: "It is used for reading files.",
        whoami_help: "It prints user information, such as username, etc., to the screen.",
        date_help: "It prints the system date and time.",
        help_help: "It prints this menu.",
        clear_help: "It clears the terminal screen.",
        reboot_help: "It restarts the system.",
        cd_help: "It allows you to change directories.",
        mv_help: "It allows you to rename files.",
        rm_help: "It allows you to delete files or directories.",
        rmdir_help: "It allows you to delete files if they are empty.",
        touch_help: "It changes the Unix timestamp of a file. If the file doesn't exist, it creates it.",
        sudo_help: "It allows you to run a command as the root user.",
        welcome: "Wake up, NEO...\n                                 \nThis is created for my personal portfolio. Just take a little stroll to see the projects I've done, my areas of interest, and my skills.\nYou can navigate through text animations by double-clicking with the mouse.\nIf you need help, the /help/ command will do the job.\nThanks for stopping by.",
